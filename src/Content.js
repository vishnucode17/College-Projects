    ...
    return (
        <div className="content">
            <div className="data">
                ...
                <div>
                    <input type="text" placeholder="learning rate" onChange={(e)=>setL_rate(e.target.value)}/>
                </div>
                <div>
                    <input type="text" placeholder="Number of iterations" onChange={(e)=>setN_iter(e.target.value)}/>
                </div>
            </div>
